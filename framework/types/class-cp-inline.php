...
class CP_Inline extends cp_Framework {
	...
	function get_options() {
		...
		$options = parent::cp_remove_field_options(
			...
			array( 'title', 'font_family', 'font_size', 'text_color', 'text_hover_color', 'back_color', 'back_color_hover', 'letter_spacing', 'btn_text_align', 'line_height', 'field_padding', 'respective_to', 'is_outside_hide', 'label_position', 'get_parameter' ),
			$options
		);
	...
	function get_design_options() {
		...
		$panel_design_options = array(
			...
			array(
				...
				'name'         => 'panel_position',
				'opts'         => array(
					'title'       => __( 'Module Position', 'convertpro' ),
					'value'       => 'middle',
